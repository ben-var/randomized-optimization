...
def main(P, mate, mutate):
    """Run this experiment"""
    training_ints = initialize_instances(TRAIN_DATA_FILE, NUM_CLASSES)
    testing_ints = initialize_instances(TEST_DATA_FILE, NUM_CLASSES)
    validation_ints = initialize_instances(VALIDATE_DATA_FILE, NUM_CLASSES)
